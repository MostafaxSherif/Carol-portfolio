...
const notebook_1 = document.querySelector("#Carol");
const notebook_2 = document.querySelector("#Carol");
const notebook_2_white = document.querySelector("#Carol");
